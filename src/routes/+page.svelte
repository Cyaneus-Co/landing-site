<main>
  <h1 class="title">Welcome to Cyaneus.</h1>
  ...
  <div class="box">
    <div id="mc_embed_shell">
      ...
      <div id="mc_embed_signup">
        <form
          action="https://cyaneus.us21.list-manage.com/subscribe/post?u=8ec1e26257e935f25a5c61caa&amp;id=5b2aac30ef&amp;f_id=006eafe1f0"
          method="post"
        ...
        >
          <div id="mc_embed_signup_scroll">
            <h2>
              Interested in Cyaneus? Sign up to be the first to know when we go
              live!
            </h2>
            ...
            <div aria-hidden="true" style="position: absolute; left: -5000px;">
              ...
              <input
                type="text"
                name="b_8ec1e26257e935f25a5c61caa_5b2aac30ef"
                tabindex="-1"
                value=""
              />
            </div>
